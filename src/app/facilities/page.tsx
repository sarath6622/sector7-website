...
export default function FacilitiesPage() {
  return (
    <>
      ...
      {/* Zone sections — alternating layout */}
                ...
                >
                  ...
                  <ScrollReveal direction={isEven ? "left" : "right"} className={!isEven ? "lg:col-start-2" : ""}>
                    ...
                    >
                      ...
                      {/* TODO: Replace with <Image fill src={zonePhoto} alt={zone.name} className="object-cover" /> */}
                    </div>
                  </ScrollReveal>
                      ...
                      <div>
                        ...
                        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          {zone.equipment.map((item) => (
                            <li
                              key={item}
                              className="flex items-start gap-2 font-body text-sm text-white/70"
                            >
                              <CheckCircle2
                                size={14}
